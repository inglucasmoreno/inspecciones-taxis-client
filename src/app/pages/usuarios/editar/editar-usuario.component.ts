...
export class EditarUsuarioComponent implements OnInit {
  ...
  public permisos = {
    ...
    inspecciones: 'INSPECCIONES_NOT_ACCESS'
  };
  ...
  getPermisos(permisosFnc: Array<string>): void {
    ...
    permisosFnc.forEach( permiso => {
      ...
      // Productos
      (permiso === 'INSPECCIONES_ALL' || permiso === "INSPECCIONES_READ") ? this.permisos.inspecciones = permiso : null;
  ...
  adicionarPermisos(): any {
    ...
    if(this.permisos.inspecciones !== 'INSPECCIONES_NOT_ACCESS'){
      permisos.push('INSPECCIONES_NAV');
      permisos.push(this.permisos.inspecciones);
    }
